  ...
  <form class="form-horizontal dy-dialog-form" id="student_form" method="post">
    ...
    <div class="form-group">
      ...
      <div class="col-xs-12 col-sm-7">
        <input type="hidden" name="user.id"  id="student_id"  />
        <div class="clearfix">
    ...
    <div class="form-group">
      <label class="control-label col-xs-12 col-sm-5 no-padding-right" for="student_telephone">绑定手机:</label>
   	  <div class="col-xs-12 col-sm-7">
        <div class="clearfix">
          <input type="text" name="user.telephone"  id="student_telephone" class="col-xs-12 col-sm-12" />
        </div>
      </div>
    </div>
    <div class="space-2"></div>
    ...
    <div class="form-group">
      ...
      <div class="col-xs-12 col-sm-7">
        <div class="clearfix">
          <input type="text" name="user.email"  id="student_email" class="col-xs-12 col-sm-12"  />
        </div>
      </div>
    </div>
    <div class="space-2"></div>
    ...
    <div class="form-group">
      ...
      <div class="col-xs-12 col-sm-7">
        <div class="clearfix">
          <input type="password" name="user.password"  id="student_password" value="" class="col-xs-12 col-sm-12"  />
        </div>
      </div>
    </div>
    <div class="space-2"></div>
    ...
    <div class="row">
        ...
        <div class="form-group">
         ...
         <div class="col-xs-12 col-sm-9">
            <div class="clearfix">
              ...
              <input type="text" name="student.name" id="student_name" class="col-xs-12 col-sm-12 spinner-input" />
            </div>
          </div>
        </div>
      </div>
      <div class="col-xs-6">
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-9">
            <div class="clearfix">
              <input type="text" name="student.nameSpell" id="student_nameSpell" class="col-xs-12 col-sm-12 spinner-input" />
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-xs-6">
        <div class="form-group">
         ...
         <div class="col-xs-12 col-sm-9">
            <div class="clearfix">
              <select class="col-xs-12 col-sm-12" id="student_gradeId" dyId="chooseId2" name="student.gradeId">
      ...
      <div class="col-xs-6">
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-9">
            <div class="clearfix">
              <select class="col-xs-12 col-sm-12" id="student_classId" dyId="chooseId2" name="student.classId">
                <option value=''>--请选择--</option>
        ...
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-9">
			  <label style="margin-right: 20px">
			    <input type="radio" name="student.sex" id="student_sex0" value="0" checked>
			    	男
			  </label>
			  
			  <label>
			    <input type="radio" name="student.sex" id="student_sex1" value="1" >
			    	女
			  </label>
          </div>
        </div>
      ...
      <div class="col-xs-6">
        <div class="form-group">
          ...
          <div class="col-xs-7 input-group">
            ...
            </span><input class="form-control" type="text" name="student.birthDate" id="student_birthDate" />
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-xs-6">
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-9">
            <div class="clearfix">
             <input type="text" name="student.studentNo" id="student_studentNo" class="col-xs-12 col-sm-12 spinner-input" />
            </div>
          </div>
        </div>
      </div>
      <div class="col-xs-6">
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-9">
            <div class="clearfix">
              <input type="text" name="student.hometown" id="student_hometown" class="col-xs-12 col-sm-12 spinner-input" />
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-xs-6">
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-9">
            <div class="clearfix">
             <input type="text" name="student.birthPlace" id="student_birthPlace" class="col-xs-12 col-sm-12 spinner-input" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="form-group">
          <label class="control-label col-xs-12 col-sm-5 no-padding-right" for="student_enrolTime">入校时间:</label>
           <div class="col-xs-7 input-group">
            <span class="input-group-addon">
                <i class="icon-calendar bigger-110"></i>
            </span><input class="form-control" type="text" name="student.enrolTime" id="student_enrolTime" />
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-xs-6">
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-9">
            <div class="clearfix">
             <input type="text" name="student.originalSchool" id="student_originalSchool" class="col-xs-12 col-sm-12 spinner-input" />
            </div>
          </div>
        </div>
      </div>
      <div class="col-xs-6">
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-9">
            <div class="clearfix">
              <input type="text" name="student.enrolScore" id="student_enrolScore" class="col-xs-12 col-sm-12 spinner-input" />
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-xs-6">
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-9">
            <div class="clearfix">
               <input type="text" name="student.idCard" id="student_idCard" class="col-xs-12 col-sm-12 spinner-input" />
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-xs-6">
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-9">
            <div class="clearfix">
               <select class="col-xs-12 col-sm-12" id="student_nation" dyId="chooseId2" name="student.nation">
                <option value=''>--请选择--</option>
      ...
      <div class="col-xs-6">
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-9">
             <div class="clearfix">
              <select class="col-xs-12 col-sm-12" id="student_political" dyId="chooseId2" name="stuInfo.political">
                <option value=''>--请选择--</option>
    ...
    <div class="row">
      <div class="col-xs-6">
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-9">
            <div class="clearfix">
                <select class="col-xs-12 col-sm-12" id="stuInfo.health" dyId="chooseId2" name="stuInfo_health">
                <option value=''>--请选择--</option>
      ...
      <div class="col-xs-6">
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-9">
             <div class="clearfix">
              <select class="col-xs-12 col-sm-12" id="student_fromWhere" dyId="chooseId2" name="student.fromWhere">
                <option value=''>--请选择--</option>
    ...
    <div class="row">
      ...
      <div class="col-xs-6">
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-9">
            <div class="clearfix">
              <input type="text" name="student.rollCode" id="student_rollCode" class="col-xs-12 col-sm-12 spinner-input" />
            </div>
          </div>
        </div>
      </div>
       ...
       <div class="col-xs-6">
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-9">
             <div class="clearfix">
                <label style="margin-right: 20px">
			    <input type="radio" name="student.isReside" id="student_isReside1" value="1" checked>
			    	走读
			  </label>
			  
			  <label>
			    <input type="radio" name="student.isReside" id="student_isReside2" value="2" >
			    	住校
			  </label>
            </div>
          </div>
    ...
    <div class="row">
      <div class="col-xs-6">
        <div class="form-group">
         ...
         <div class="col-xs-12 col-sm-9">
            <div class="clearfix">
              <input type="text" name="student.telephone" id="student_telephone" class="col-xs-12 col-sm-12 spinner-input" />
            </div>
          </div>
        </div>
      </div>
      <div class="col-xs-6">
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-9">
            <div class="clearfix">
              <input type="text" name="stuInfo.ziplCode" id="student_ziplCode" class="col-xs-12 col-sm-12 spinner-input" />
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="form-group">
         ...
         <div class="col-xs-12 col-sm-9">
             <div class="clearfix">
        	   <input type="text" name="student.homeAddr" id="student_homeAddr" class="col-xs-10 col-sm-12 spinner-input" />
        	</div>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="form-group">
         ...
         <div class="col-xs-12 col-sm-9">
           <div class="clearfix">
        	  <input type="text" name="stuInfo.postalAddr"  id="student_postalAddr" class="col-xs-12 col-sm-12"  />
        	</div>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-xs-6">
        <div class="form-group">
         ...
         <div class="col-xs-12 col-sm-9">
            <div class="clearfix">
              <input type="text" name="stuInfo.householdLocation" id="student_householdLocation" class="col-xs-12 col-sm-12 spinner-input" />
            </div>
          </div>
        </div>
      </div>
      <div class="col-xs-6">
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-9">
            <div class="clearfix">
              <select class="col-xs-12 col-sm-12" id="student_householdNature" dyId="chooseId2" name="stuInfo.householdNature">
                <option value=''>--请选择--</option>
    ...
    <div class="row">
      <div class="col-xs-6">
        <div class="form-group">
         ...
         <div class="col-xs-12 col-sm-9">
           <div class="clearfix">
              <select class="col-xs-12 col-sm-12" id="student_disabilityType" dyId="chooseId2" name="stuInfo.disabilityType">
                <option value=''>--请选择--</option>
      ...
      <div class="col-xs-6">
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-9">
            <div class="clearfix">
              <select class="col-xs-12 col-sm-12" id="student_stay" dyId="chooseId2" name="stuInfo.stay">
                <option value=''>--请选择--</option>
    ...
    <div class="row">
      <div class="col-xs-6">
        <div class="form-group">
         ...
         <div class="col-xs-12 col-sm-9">
           <label style="margin-right: 20px">
			    <input type="radio" name="stuInfo.migrant" id="student_migrant1" value="1" checked>
			    	是
			  </label>
			  
			  <label>
			    <input type="radio" name="stuInfo.migrant" id="student_migrant2" value="2" checked>
			    	否
			  </label>
          </div>
        </div>
      ...
      <div class="col-xs-6">
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-9">
            <label style="margin-right: 20px">
			    <input type="radio" name="stuInfo.soldier" id="student_soldier1" value="1" checked>
			    	是
			  </label>
			  
			  <label>
			    <input type="radio" name="stuInfo.soldier" id="student_soldier2" value="2" checked>
			    	否
			  </label>
          </div>
        </div>
    ...
    <div class="row">
      <div class="col-xs-6">
        <div class="form-group">
         ...
         <div class="col-xs-12 col-sm-9">
           <label style="margin-right: 20px">
			    <input type="radio" name="stuInfo.teacher" id="student_teacher1" value="1" checked>
			    	是
			  </label>
			  
			  <label>
			    <input type="radio" name="stuInfo.teacher" id="student_teacher2" value="2" checked>
			    	否
			  </label>
          </div>
        </div>
      ...
      <div class="col-xs-6">
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-9">
            <label style="margin-right: 20px">
			    <input type="radio" name="stuInfo.singleParent" id="student_singleParent1" value="1" checked>
			    	是
			  </label>
			  
			  <label>
			    <input type="radio" name="stuInfo.singleParent" id="student_singleParent2" value="2" checked>
			    	否
			  </label>
          </div>
        </div>
    ...
    <div class="space-2"></div>
      ...
      <div class="col-xs-6">
        <div class="form-group">
         ...
         <div class="col-xs-12 col-sm-9">
           <label style="margin-right: 20px">
			    <input type="radio" name="stuInfo.onlySon" id="student_onlySon1" value="1" checked>
			    	是
			  </label>
			  
			  <label>
			    <input type="radio" name="stuInfo.onlySon" id="student_onlySon2" value="2" checked>
			    	否
			  </label>
          </div>
        </div>
      ...
      <div class="col-xs-6">
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-9">
            <label style="margin-right: 20px">
			    <input type="radio" name="stuInfo.poor" id="student_poor1" value="1" checked>
			    	是
			  </label>
			  
			  <label>
			    <input type="radio" name="stuInfo.poor" id="student_poor2" value="2" checked>
			    	否
			  </label>
          </div>
        </div>
