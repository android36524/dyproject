...
<div>
  <form class="form-horizontal dy-dialog-form" id="student_form" method="post">
        ...
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-9">
			   <label style="margin-right: 20px">
			    <input type="radio" name="student.sex" id="student_sex0"  value="${manVal}"  checked >
			     <span>${manName}</span>
			  </label>
			  
			  <label>
			    <input type="radio" name="student.sex" id="student_sex1" value="${woManVal}" >
			   <span>${woManName}</span>
			  </label>
          </div>
        </div>
    ...
    <div class="row">
      ...
      <div class="col-xs-6">
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-9">
            <div class="clearfix">
              <input type="text" name="student.enrolScore" id="student_enrolScore" class="col-xs-12 col-sm-12 spinner-input"  onkeyup="clearNoNumOfAlert(this)" style="ime-mode:Disabled"/>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-xs-6">
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-9">
            <div class="clearfix">
                <select class="col-xs-12 col-sm-12" id="student_health" dyId="chooseId2" name="stuInfo.health">
                <option value=''>--请选择--</option>
       ...
       <div class="col-xs-6">
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-9">
             <div class="clearfix">
			   <label style="margin-right: 20px">
			    <input type="radio" name="student.isReside" id="student_isReside1"  value="${goReadVal}"  checked >
			     <span>${goReadName}<span>
			  </label>
			  
			  <label>
			    <input type="radio" name="student.isReside" id="student_isReside2" value="${ResidenceVal}" >
    ...
    <div class="row">
      <div class="col-xs-6">
        <div class="form-group">
         ...
         <div class="col-xs-12 col-sm-9">
           <label style="margin-right: 20px">
		    <input type="radio" name="stuInfo.migrant" id="student_migrant1" value="${radioYesVal}" >
		    <span>${radioYesName}<span>
		  </label>
		  
		  <label>
		    <input type="radio" name="stuInfo.migrant" id="student_migrant2" value="${radioNotVal}" >
      ...
      <div class="col-xs-6">
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-9">
            <label style="margin-right: 20px">
			    <input type="radio" name="stuInfo.soldier" id="student_soldier1"  value="${radioYesVal}"  >
			     <span>${radioYesName}<span>
			  </label>
			  
			  <label>
			    <input type="radio" name="stuInfo.soldier" id="student_soldier2" value="${radioNotVal}" >
			   <span>${radioNotName}<span>
			  </label>
          </div>
        </div>
    ...
    <div class="row">
      <div class="col-xs-6">
        <div class="form-group">
         ...
         <div class="col-xs-12 col-sm-9">
           <label style="margin-right: 20px">
			    <input type="radio" name="stuInfo.teacher" id="student_teacher1" value="${radioYesVal}" >
			      <span>${radioYesName}<span>
			  </label>
			  
			  <label>
			    <input type="radio" name="stuInfo.teacher" id="student_teacher2" value="${radioNotVal}" >
			    <span>${radioNotName}<span>
			  </label>
          </div>
        </div>
      ...
      <div class="col-xs-6">
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-9">
            <label style="margin-right: 20px">
			    <input type="radio" name="stuInfo.singleParent" id="student_singleParent1" value="${radioYesVal}"  >
			    <span>${radioYesName}<span>
			  </label>
			  
			  <label>
			    <input type="radio" name="stuInfo.singleParent" id="student_singleParent2" value="${radioNotVal}" >
			     <span>${radioNotName}<span>
			  </label>
          </div>
        </div>
    ...
    <div class="space-2"></div>
      ...
      <div class="col-xs-6">
        <div class="form-group">
         ...
         <div class="col-xs-12 col-sm-9">
           <label style="margin-right: 20px">
			    <input type="radio" name="stuInfo.onlySon" id="student_onlySon1" value="${radioYesVal}" >
			    <span>${radioYesName}<span>
			  </label>
			  
			  <label>
			    <input type="radio" name="stuInfo.onlySon" id="student_onlySon2" value="${radioNotVal}" >
			     <span>${radioNotName}<span>
			  </label>
          </div>
        </div>
      ...
      <div class="col-xs-6">
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-9">
            <label style="margin-right: 20px">
			    <input type="radio" name="stuInfo.poor" id="student_poor1" value="${radioYesVal}" >
			     <span>${radioYesName}<span>
			  </label>
			  
			  <label>
			    <input type="radio" name="stuInfo.poor" id="student_poor2" value="${radioNotVal}" >
			    <span>${radioNotName}<span>
			  </label>
          </div>
        </div>
    ...
    <div class="form-group">
      <label class="control-label col-xs-12 col-sm-5 no-padding-right" for="student_role">所属角色:</label>
      <div class="col-xs-12 col-sm-7">
        <div class="clearfix">
