    ...
    <div class="row">
      <div class="col-xs-6">
        ...
        <div class="form-group">
          ...
          <label class="control-label col-xs-12 no-padding-right" for="empe_nameSpell" >姓名拼音简拼:</label>
          <div class="col-xs-7 input-group">
            <div class="clearfix">
    ...
    <div class="row">
      ...
      <div class="col-xs-6">
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-9">
            <div class="clearfix">
              <input type="text" name="empe.graduateSchool" id="empe_graduateSchool" class="col-xs-12 col-sm-12 spinner-input" disabled="disabled"/>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-xs-6">
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-7 input-group">
               <span class="input-group-addon">
                <i class="icon-calendar bigger-110"></i>
            </span><input class="form-control" type="text" name="edu.entryDate" id="empe_entryDate" disabled="disabled"/>
          </div>
        </div>
      </div>
      <div class="col-xs-6">
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-7 input-group">
            <span class="input-group-addon">
                <i class="icon-calendar bigger-110"></i>
            </span><input class="form-control" type="text" name="edu.startWorkDate" id="empe_startWorkDate" disabled="disabled"/>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="col-xs-12">
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-10">
            <div class="clearfix">
              <textarea class="col-xs-12 col-sm-12" name="edu.dutyInfo" id="empe_dutyInfo" disabled="disabled"></textarea>
            </div>
          </div>
        </div>
      </div>
