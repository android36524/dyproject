...
$(document).ready(function () {
    ...
    var id =$("#empe_id").val();
    if(id){
        $.get(path + "/admin/empe/queryById?id="+id,function(ret){
    ...
    //时间选择
    $('#empe_birthDate,#empe_entryDate,#empe_startWorkDate').datepicker({
        language:'zh-CN',
        autoclose:true,
        pickTime: false,
        todayBtn: true,
    ...
    $("#empe_form").validate({
        ...
        rules : {
            ...
            "empe.mobile" : {
                ...
                required: true,
                remote : {
                    url:path+"/admin/empe/validateEmpeMobile",
                    type:"post",
                    async:false,
                    dataType:"json",
                    data:{
