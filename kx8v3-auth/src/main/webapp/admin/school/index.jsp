	...
	<div class="main-container container-fluid">
		...
		<div class="main-content">
			...
			<div class="page-content">
				...
				<div class="col-xs-12">
					<p>
						<dytags:authBtn name="新增" code="add" id="btn-addSchool"
							btnClass="btn btn-success" lableClass="icon-pencil bigger-125" />
						<dytags:hasAuth />
					</p>
						</div>	
						<div class="form-group col-md-6" >
						   <label>学校名称：</label><input type="text" class="input" id="schoolName" maxlength="50"/>
						   <label>状态：</label>
					...
					<!-- 学校列表 -->
					<div class="col-xs-12" >
						<table id="school-table"></table>
						<div id="school-pager"></div>
					</div>
				</div>
			</div>
			</div>
