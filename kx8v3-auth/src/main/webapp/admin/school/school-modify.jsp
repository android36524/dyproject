...
<%
	...
	String schoolLevel = OrgLevelEnum.SCHOOL.getValueStr();
%>
<script type="text/javascript">
	var _id = "<%=id%>";
	var _schoolLevel = "<%=schoolLevel%>";
</script>
...
<div>
	<form class="form-horizontal dy-dialog-form" id="school_form" 
		...
		<input type="hidden" name="school.orgId" id="orgId" value="<%= orgId%>"/>
      ...
      <div class="form-group" id="roleDiv">
		...
		<div class="row">
			...
			<div class="col-xs-6">
				<div class="form-group">
					<label class="control-label col-xs-12 col-sm-5 no-padding-right"
						for="schoolExt_schProperty"><b class="tips">*</b>学校办别:</label>
					<div class="col-xs-12 col-sm-9">
						<div class="clearfix">
							<select name="schoolExt.schProperty" class="col-xs-12 col-sm-9"
								id="schoolExt_schProperty">
								<option value="">-请选择-</option>
								<c:forEach items="${schPropertyList }" var="item">
									<option value="${item.value }">${item.name }</option>
								</c:forEach>
							</select>
						</div>
				...
				<div class="form-group">
					...
					<div class="col-xs-12 col-sm-9">
						...
						<input id="areaId" name="areaId" type="hidden"/>
							...
							class="col-sm-3" style="margin-right: 5px;width: 150px">
								<option value="">-请选择-</option>
		...
		<div class="row">
			...
			<div class="col-xs-6">
				<div class="form-group">
					<label class="control-label col-xs-12 col-sm-5 no-padding-right"
						for="school.orgNameSpell">学校名称简拼:</label>
					<div class="col-xs-12 col-sm-9">
						<div class="clearfix">
							<input type="text" name="school.orgNameSpell" readonly="readonly"
								id="school_orgNameSpell" class="col-xs-12 col-sm-9" />
						</div>
					</div>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-xs-12 col-sm-9">
						<div class="clearfix">
							<input type="text" name="schoolExt.legalPerson"
								id="schoolExt_legalPerson" class="col-xs-12 col-sm-9" />
						</div>
					</div>
				</div>
			</div>
					...
					<div class="col-xs-12 col-sm-9">
						<div class="clearfix">
							<input type="text" name="schoolExt.length" id="schoolExt_length"
								class="col-xs-12 col-sm-9" /><span>年</span>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="row">
		   <div class="col-xs-6" style="display: none">
				<div class="form-group">
					<label class="control-label col-xs-12 col-sm-5 no-padding-right"
						for="school_level">层级:</label>
					<div class="col-xs-12 col-sm-9">
						<div class="clearfix">
							<input type="text" name="school.level" id="school_level" value="8604"
								class="col-xs-12 col-sm-9" />
						</div>
					</div>
				</div>
