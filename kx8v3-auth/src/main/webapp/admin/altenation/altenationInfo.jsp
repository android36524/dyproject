						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<form class="form-horizontal dy-dialog-form" id="alter_form" method="post">
									<div class="col-xs-12">
										<div class="form-group col-md-1" align="right">   <label>所在部门：</label> </div>
										...
										<div class="form-group col-md-1"  align="right">   <label>异动类别：</label> </div>
										<div class="form-group col-md-2" > 
											<div class="col-xs-12  input-group">
												<select id="alterType" style="width:175px">
													<option value="">请选择</option>
													<c:forEach var="alterType" items="${alterList }">
														<option value="${alterType.value }">${alterType.name }</option>
													</c:forEach>
												</select> 
											</div>	
										</div>
										...
										<div class="form-group col-md-1" > 
										    <div class="col-xs-12  input-group"> <input type="text" maxlength="20" class="input" id="name" /> 	
										</div>
									</div>							
									<div class="col-xs-12">	 	
											...
											<div class="form-group col-md-2" >  
												<select id="status" style="width:180px">				
													...
													<c:forEach var="alterStatus" items="${alterStatus }">
														<option value="${alterStatus.value }">${alterStatus.name }</option>
													</c:forEach>
												</select> 
											</div>
											<div class="form-group col-md-1"  align="right">   <label>异动时间：</label> </div>
											<div class="form-group col-md-2" >
												<div class="col-xs-12  input-group">
													<span class="input-group-addon">
														<i class="icon-calendar bigger-110"></i>
													</span>
													<input class="form-control" type="text" name="startDate" id="alter_startDate" />	
												</div>
											</div>
											<div class="form-group col-md-1"  align="right">   <label>到：</label> </div>
											<div class="form-group col-md-2" > 
												<div class="col-xs-12 col-sm-12 input-group"> 
													<span class="input-group-addon">
														<i class="icon-calendar bigger-110"></i>
													</span>
													<input class="form-control" type="text" name="endDate" id="alter_endDate" />	
												</div>
											</div>
