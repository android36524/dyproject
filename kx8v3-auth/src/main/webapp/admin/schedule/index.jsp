...
<link rel="stylesheet"
	href="<%=rootPath%>/public/bootstrap/ace/css/chosen.css" />
<script
	src="<%=__BacePath%>/public/bootstrap/ace/js/chosen.jquery.min.js"></script>
						...
						<div>
							...
							<form name="form-search" id="form-search">
								<div class="form-group col-md-6">
									<label>年级别名：</label> <select id="gradeId" style="width: 150px;">
										<option value="">-请选择-</option>
										<c:forEach var="grade" items="${gradeList }">
											<option value="${grade.id}">${grade.name}</option>
										</c:forEach>
									</select> <label>班级名称</label> <select id="className"
										style="width: 155px"></select> <input type="button"
								...
								<div>
									<input type="button"
										class="col-xs-12 btn btn-primary dy-search-button"
										id="batchfind_btn" value="批量课表查询" />
								</div>
							</form>
							<!-- 班级列表 -->
