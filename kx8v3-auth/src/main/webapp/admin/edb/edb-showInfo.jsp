    ...
    <div class="form-group" id="accoutDiv">
      <label class="control-label col-xs-12 col-sm-5 no-padding-right" for="account_account">账号:</label>
        <div class="col-xs-12 col-sm-7">
          <div class="clearfix">
            <input type="text" name="account.account" id="account_account" value="${account }" class="col-xs-12 col-sm-12"  />
          </div>
        </div>  
      </div> 
      ...
      <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-7">
          <div class="clearfix">
            ...
            <input type="text" name="edb.orgName" id="edb_orgName" class="col-xs-12 col-sm-12" disabled="disabled"/>
      ...
      <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-7">
          ...
          <input type="hidden" id="edb_provinceCode_hidden" name="edb.provinceCode"/>
            <select class="col-xs-12 col-sm-12 area" id="edb_provinceCode" name="edb_provinceCode" disabled="disabled">
      ...
      <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-7">
          ...
          <input type="hidden" id="edb_cityCode_hidden" name="edb.cityCode"/>
            <select class="col-xs-12 col-sm-12 area" id="edb_cityCode" disabled="disabled" >
              <option value="">--请选择--</option>
            </select>
          </div>
        </div>
      ...
      <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-7">
          <div class="clearfix">
            <select class="col-xs-12 col-sm-12 area" id="edb_areaCode" name="edb.areaCode" disabled="disabled">
              <option value="">--请选择--</option>
            </select>
      ...
      <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-7">
          <div class="clearfix">
            <input type="text" name="edb.charge" id="edb_charge" class="col-xs-12 col-sm-12" disabled="disabled"/>
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-7">
          <div class="clearfix">
            <input type="text" name="edb.chargePhone" id="edb_chargePhone" class="col-xs-12 col-sm-12" disabled="disabled"/>
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-7">
          <div class="clearfix">
            <input type="text" name="edb.officeAddr" id="edb_officeAddr" class="col-xs-12 col-sm-12" disabled="disabled" />
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-7">
          <div class="clearfix">
            <input type="text" name="edb.zipCode" id="edb_zipCode" class="col-xs-12 col-sm-12" disabled="disabled" />
          </div>
        </div>
      </div>
      ...
      <div class="form-group" style="display: none">
        ...
        <div class="col-xs-12 col-sm-7">
          <div class="clearfix">
            <input type="text" name="edb.level" id="edb_level" class="col-xs-12 col-sm-12"  disabled="disabled"/>
          </div>
        </div>
      </div>
  </form>
